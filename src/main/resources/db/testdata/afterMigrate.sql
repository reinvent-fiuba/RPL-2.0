...
VALUES (2, 1, 1, 'Ej2 Unit Test C',
        'La descripción del ejericio 2', 'c_std11', false, true, false, '//El codigo inicial', 1, 10,
        now(), now());

INSERT INTO activities
VALUES (3, 1, 1, 'Ej 3 Unit Test Python',
        'La descripción del ejericio 3', 'python_3.7', false, true, false, '#El codigo inicial', 1, 10,
        now(), now());
...
VALUES (5, 1, 1, 'El ejericio 5',
        'La descripción del ejericio 5', 'c_std11', true, true, false, '//El codigo inicial', 1, 10,
        now(), now());
...
VALUES (6, 1, 2, 'Pasar de segundos a horas, minutos, segundos',
        'Dada una cantidad de segundos, devolver/imprimir la cantidad de horas', 'c_std11', true,
        true, false, '//El codigo inicial', 1, 10,
        now(), now());

INSERT INTO activities
VALUES (7, 1, 2, 'El ejericio 2',
        'La descripción del ejericio 2', 'c_std11', true, true, false, '//El codigo inicial', 1, 10,
        now(), now());

INSERT INTO activities
VALUES (8, 1, 2, 'El ejericio 3',
        'La descripción del ejericio 3', 'c_std11', true, true, false, '//El codigo inicial', 1, 10,
        now(), now());
